...
func init() {
	...
	flag.StringVar(&v3tov4, "v3tov4", "", "Converts v3 config into v4. v3tov4=/path/to/defenition:/path/to/config:/path/to/output:overwrite")
...
func main() {
	...
	if v3tov4 != "" {
		...
		pathConfiguration = v3tov4Args[0]
		pathDefinition = v3tov4Args[1]
		pathOutput = v3tov4Args[2]
		overwrite = v3tov4Args[3] == "true"

		migrate.V3toV4(pathConfiguration, pathDefinition, pathOutput, overwrite)
